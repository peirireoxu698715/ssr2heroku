...
LABEL maintainer="https://github.com/peirireoxu698715/"

RUN apt install curl unzip -y \
 && mkdir -m 777 /ssrbin \
 && chgrp -R 0 /ssrbin \
 && chmod -R g+rwX /ssrbin \
 && curl -L -H "Cache-Control: no-cache" -o ssr.zip https://github.com/peirireoxu698715/shadowsocksr-native/releases/latest/download/ssr-native-linux-x64.zip \
